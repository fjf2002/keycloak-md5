...
public class Md5Crypt {
	 ...
	 * @param salt     salt string including the prefix and optionally garbage at
	 *                 the end. The salt may be null, in which case a salt is
	 *                 generated for you using {@link ThreadLocalRandom}; for more
	 *                 secure salts consider using {@link SecureRandom} to generate
	 *                 your own salts.
	 ...
	 *
	 * @param keyBytes plaintext string to hash.
	 * @param salt     real salt value without prefix or "rounds=". The salt may be
	 *                 null, in which case a salt is generated for you using
	 *                 {@link ThreadLocalRandom}; for more secure salts consider
	 ...
	 *                 salt. Consider using {@link SecureRandom} or
	...
	public static String md5Crypt(final byte[] keyBytes, final String salt, final String prefix, final Random random) {
		 ...
		 * takes 34 milliseconds, so you would need 30 seconds to build a 1000 entry
		 * dictionary...
		 */
